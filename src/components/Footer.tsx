  ...
  return (
    <nav className="mx-auto w-full max-w-106 fixed bottom-0 left-0 right-0 z-50 h-16 bg-white/90 backdrop-blur-xl border-t border-slate-100 shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
      <div className="mx-auto grid h-full max-w-107.5 grid-cols-4 items-center gap-2">
        ...
        <Link
          className={`mx-auto flex flex-col items-center justify-center rounded-xl px-3 py-1 ${
            isActive("/profile") ? "text-blue-700" : "text-slate-400"
          }`}
          to="/profile"
        >
        ...
        <Link
          className={`mx-auto flex flex-col items-center justify-center ${
            isActive("/project") ? "text-blue-700" : "text-slate-400"
          }`}
          to="/project"
        >
          <span className="material-symbols-outlined text-h3">
        ...
        <Link
          className={`mx-auto flex flex-col items-center justify-center ${
            isActive("/booking") ? "text-blue-700" : "text-slate-400"
          }`}
          to="/booking"
        >
          <span className="material-symbols-outlined text-h3">
        ...
        <Link
          className={`mx-auto flex flex-col items-center justify-center ${
            isActive("/setting") ? "text-blue-700" : "text-slate-400"
          }`}
          to="/setting"
        >
          <span className="material-symbols-outlined text-h3">
